...
public abstract class AbstractSail implements Sail {
	...
	/**
	 * default SPARQL query evaluation mode, set to {@link QueryEvaluationMode#STANDARD}
	 */
	private QueryEvaluationMode defaultQueryEvaluationMode = QueryEvaluationMode.STANDARD;
